    ...
    <div className={`relative ${className}`} ref={componentRef}>
      <div className="relative">
        ...
        <input
          ...
          className="w-full pl-10 pr-4 py-3 bg-white dark:bg-[#171923] border border-gray-300 dark:border-white/10 rounded-lg text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500 transition-all"
          autoComplete="off"
        />
      ...
      {showDropdown && (
        <div className="absolute z-20 w-full mt-2 py-1 bg-white dark:bg-[#171923] rounded-lg border border-gray-200 dark:border-white/10 max-h-60 overflow-y-auto shadow-xl">
          <div className="px-4 py-2 text-sm font-medium text-gray-500 dark:text-gray-400 border-b border-gray-200 dark:border-[#2A2D3A]">
          ...
          {suggestions.length > 0 ? (
            suggestions.map((school) => (
              <button
                ...
                className="w-full px-4 py-3 text-left hover:bg-gray-100 dark:hover:bg-[#2A2D3A] transition-all"
              >
          ...
          {input.length > 0 && (
            <button
              ...
              className="w-full px-4 py-3 text-left hover:bg-gray-100 dark:hover:bg-[#2A2D3A] transition-all border-t border-gray-200 dark:border-[#2A2D3A]"
            >
