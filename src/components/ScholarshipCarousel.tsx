...
export function ScholarshipCarousel() {
    ...
    const fetchScholarships = async () => {
      try {
        ...
        if (data && data.length > 0) {
          // Add a simulated match score (would normally come from an algorithm)
        ...
        // Fallback to example scholarships if fetch fails
      } finally {
        setLoading(false);
      }
    };
  ...
  if (loading) {
    return (
      <div className="w-full max-w-md mx-auto h-[360px] flex items-center justify-center bg-white/70 dark:bg-surface-dark-100/60 rounded-xl border border-gray-200/50 dark:border-surface-dark-50/30">
  ...
  return (
    <div className="relative w-full max-w-md mx-auto h-[360px]">
      <AnimatePresence mode="wait">
        ...
        >
          <div className="relative backdrop-blur-sm bg-white/70 dark:bg-surface-dark-100/60 rounded-xl border border-gray-200/50 dark:border-surface-dark-50/30 p-6 overflow-hidden shadow-lg hover:shadow-premium hover:border-primary-200 dark:hover:border-primary-900/30 transition-all duration-300">
            {/* Progress bar */}
            <div className="absolute top-0 left-0 w-full h-1 bg-gray-100 dark:bg-surface-dark-50/20">
              <motion.div
                initial={{ width: "0%" }}
                animate={{ width: "100%" }}
            ...
            <div className="pt-2">
              <div className="flex items-start justify-between mb-2">
                ...
                <div className="flex items-center gap-1.5 bg-primary-50 dark:bg-primary-900/30 text-primary-600 dark:text-primary-400 px-2.5 py-1 rounded-full shadow-sm whitespace-nowrap">
              ...
              <div className="grid grid-cols-3 gap-2 mb-8">
                <div className="flex flex-col items-center p-3 rounded-lg bg-primary-50 dark:bg-primary-900/20">
                ...
                <div className="flex flex-col items-center p-3 rounded-lg bg-accent-50 dark:bg-accent-900/20">
                  <Clock className="w-4 h-4 text-accent-600 dark:text-accent-400 mb-1" />
                ...
                <div className={`flex flex-col items-center p-3 rounded-lg ${getCompetitionBg(currentScholarship.competition_level)}`}>
                  ...
                  <span className={`text-sm font-medium ${getCompetitionColor(currentScholarship.competition_level)}`}>
